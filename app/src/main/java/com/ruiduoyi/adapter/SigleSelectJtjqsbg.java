...
public abstract class SigleSelectJtjqsbg extends ArrayAdapter{
    private Context context;
    private List<Map<String,String>> userList;
    HashMap<String,Boolean> states=new HashMap<String,Boolean>();//用于记录每个RadioButton的状态，并保证只可选一个
    private int resource;

    public SigleSelectJtjqsbg(Context context, int resource, List<Map<String,String>> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final SigleSelectJtjqsbg.ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(resource, null);
            holder = new SigleSelectJtjqsbg.ViewHolder();
            ...
            holder.lab_4=(TextView)convertView.findViewById(R.id.lab_4);
            convertView.setTag(holder);
        }else{
            holder=(SigleSelectJtjqsbg.ViewHolder) convertView.getTag();
        }
        ...
        holder.lab_4.setText(userList.get(position).get("lab_4"));
//当RadioButton被选中时，将其状态记录进States中，并更新其他RadioButton的状态使它们不被选中
        holder.background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SigleSelectJtjqsbg.this.notifyDataSetChanged();
            }
        });
